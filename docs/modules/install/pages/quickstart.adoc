...
To install Web-UI from sources, run this command in rackdsdb/web/ui to install 
...
https://github.com/rackslab/RacksDB/blob/main/racksdb/web/ui/README.md[README] 
for more details.
...
Web-UI is included in `racksdb-web`. Users can launch the UI by running the
command:
...
NOTE: UI is accessible through localhost/5000
...
* xref:usage:ui.adoc[Web-UI reference documentation]
--
