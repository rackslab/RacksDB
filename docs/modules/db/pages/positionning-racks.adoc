...
image:racks_rows_positionning_example_map.svg[Uncommon datacenter room map,800]
...
image:racks_rows_positionning_example_rows.svg[Datacenter room map racks rows,800]
...
image:racks_rows_positionning_example_annoted.svg[Racks rows positionning example,800]
...
xref:structure.adoc#obj-datacenterroomrow[DatacenterRoomRow] object.
--
...
xref:structure.adoc#obj-datacenterroomrow[DatacenterRoomRow] object, to
orientate the rack doors to the top of the room.
--
...
xref:structure.adoc#obj-datacenterroomrow[DatacenterRoomRow] object, with a
value of 30° using the xref:structure.adoc#deftype-angle[~angle] defined type.
--
