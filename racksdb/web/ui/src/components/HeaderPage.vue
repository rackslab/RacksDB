...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <header>
        <img alt="Rackslab logo" src="/assets/racksdb_logo.svg" width="125" height="125" />

        <nav>
            <RouterLink to="/">Home</RouterLink>
            <RouterLink to="/datacenters">Datacenters</RouterLink>
            <RouterLink to="/infrastructures">Infrastructures</RouterLink>
        </nav>
