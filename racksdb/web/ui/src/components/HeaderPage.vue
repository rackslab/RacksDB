...
<template>
    <header class="flex justify-between items-center p-4 px-20">
        <div>
            <router-link to="/"><img alt="Rackslab logo" src="/assets/racksdb_logo.svg" class="h-32 w-32"/></router-link>
        </div>
        ...
        <nav class="space-x-4">
            ...
            <router-link to="/datacenters">
                <span v-if="isDatacentersRouteActive()" class="text-purple-700 font-medium">Datacenters</span>
                <span v-else>Datacenters</span>
            </router-link>

            <router-link to="/infrastructures">
                <span v-if="isInfrastructuresRouteActive()" class="text-purple-700 font-medium">Infrastructures</span>
